...
class MockAuthService implements AuthService {
  ...
  @override
  Stream<UserModel> get onAuthStateChanged => _onAuthStateChangedController.stream;
  ...
  Future<UserModel> createUserWithEmailAndPassword(
    ...
    final UserModel user = UserModel(uid: random.randomAlphaNumeric(32), email: email);
  ...
  @override
  Future<UserModel> signInWithEmailLink({String email, String emailLink}) async {
    await Future<void>.delayed(responseTime);
